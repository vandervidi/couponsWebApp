                        ...
                        <div class = "container">
                                ...
                                <div class = "collapse navbar-collapse navHeaderCollapse">                              
                                        <ul class = "nav navbar-nav navbar-right">
												...
												<li class="active"><a href="../controller/expiredCoupons">Expired coupons</a></li>
...
<div class="container"><h2>Expired Coupons <small> Coupons with an expired date</small></h2></div>
